...
export const sendTwoFactorCodeEmail = async (email, verificationCode) => {
        ...
        <style>
          * { box-sizing: border-box; }
          ...
          @media (max-width: 600px) {
            ...
            .code { letter-spacing: 0.18em; font-size: 28px; }
          }
        </style>
      </head>
      <body>
        <div class="wrapper">
          <div class="container">
            <div class="header">
              ...
              <p>Secure access for your NDC CMS account</p>
            </div>

            <div class="content">
              <p class="greeting">Hello,</p>
              <p class="details">A sign-in attempt was made for your account <strong>${safeEmail}</strong>. Use the verification code below to continue securely.</p>
              ...
              <p class="details">This code expires in 10 minutes and is valid for one login attempt.</p>
              <div class="note">If you did not attempt to sign in, please ignore this email and contact your administrator immediately.</div>
            </div>

            <div class="footer">
              <p>This is an automated security email generated by NDC CMS.</p>
  ...
  await sendEmail(email, "Your NDC CMS verification code", htmlContent);
};

// Logo removed from email templates per admin preference.
...
export const sendForgotPasswordEmail = async (email, resetToken) => {
  ...
  const resetLink = new URL("reset-password", `${normalizedBaseUrl}/`);

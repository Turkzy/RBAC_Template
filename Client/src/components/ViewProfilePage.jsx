...
const ViewProfilePage = ({
  ...
  return (
    <div className="w-full mx-auto px-2 sm:px-4 lg:px-6 2xl:px-8">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-4 gap-5">
            ...
            >
              {user.imageUrl && !imageError ? (
                <img
                  ...
                  alt="Profile"
                  className="w-32 h-32 sm:w-60 sm:h-60 md:w-48 md:h-48 lg:w-64 lg:h-64 xl:w-64 2xl:w-72 2xl:h-72 rounded-2xl object-cover border border-slate-200 dark:border-slate-700 shadow-sm"
                  onError={() => setImageError(true)}
                />
              ) : (
                <div className="w-32 h-32 sm:w-60 sm:h-60 md:w-48 md:h-48 lg:w-60 lg:h-60 xl:w-64 2xl:w-72 2xl:h-72 rounded-2xl bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-300 text-2xl sm:text-3xl md:text-4xl font-bold shadow-sm">
                  {getUserInitials()}
                </div>
              )}
